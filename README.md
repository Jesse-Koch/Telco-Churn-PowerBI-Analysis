...
- Ten drivers were tested and ranked using a **percentage-point-gap** ranking methodology; gender was tested and explicitly ruled out (0.7-point gap, considered negligible).
